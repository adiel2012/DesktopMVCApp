...
public class PersonaAdicionarFrame extends javax.swing.JFrame {
    ...
    public static PersonaAdicionarFrame getInstance() {
        if (instance == null) {
            instance = new PersonaAdicionarFrame();
        }
        return instance;
    ...
    public void mostrar() {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PersonaAdicionarFrame.getInstance().setVisible(true);
            }
        });
    }

    /**
     * Creates new form PersonaAdicionarFrame
     */
    private PersonaAdicionarFrame() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PersonaAdicionarFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PersonaAdicionarFrame().setVisible(true);
            }
        });
    }
